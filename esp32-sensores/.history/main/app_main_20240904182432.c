...
{   
    ...
    while (1)
    {
        ...
        snprintf(temperatura, sizeof(temperatura), "%.2f", temperature);
        snprintf(umidade, sizeof(umidade), "%.2f", humidity);
        snprintf(farol, sizeof(farol), "%d", farolStatus);
        snprintf(luzInterna, sizeof(luzInterna), "%d", luzInternaPwm);
