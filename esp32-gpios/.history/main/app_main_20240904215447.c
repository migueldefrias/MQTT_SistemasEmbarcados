...
void configuraPinos(){
    ...
    esp_rom_gpio_pad_select_gpio(descerVidros, GPIO_MODE_OUTPUT);
    // gpio_set_direction(descerVidros, GPIO_MODE_OUTPUT);

    esp_rom_gpio_pad_select_gpio(buzina, GPIO_MODE_OUTPUT);
    // gpio_set_direction(buzina, GPIO_MODE_OUTPUT);

    esp_rom_gpio_pad_select_gpio(farol, GPIO_MODE_OUTPUT);
    // gpio_set_direction(farol, GPIO_MODE_OUTPUT);

    esp_rom_gpio_pad_select_gpio(setas, GPIO_MODE_OUTPUT);
    // gpio_set_direction(setas, GPIO_MODE_OUTPUT);

    esp_rom_gpio_pad_select_gpio(travaDestrava, GPIO_MODE_OUTPUT);
    // gpio_set_direction(travaDestrava, GPIO_MODE_OUTPUT);

    esp_rom_gpio_pad_select_gpio(luzInterna, GPIO_MODE_OUTPUT);
...
void app_main(void)
{
    ...
    gpio_isr_handler_add(botaoPorta, gpio_isr_handler, (void *) porta);
    gpio_isr_handler_add(botaoBiometria, gpio_isr_handler, (void *) posChave);
    gpio_isr_handler_add(botaoIgnicao, gpio_isr_handler, (void *) botaoTravar);
