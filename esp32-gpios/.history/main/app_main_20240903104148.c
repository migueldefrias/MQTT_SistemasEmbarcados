...
void enviaEstadoGpio(){
    while(1){
        ...
        snprintf1(attributes, sizeof(attributes), "{\"porta\": %d, \"posChave\": %d, \"freio\": %d, \"botaoTravar\": %d}", portaStatus, posChaveStatus, freioStatus, botaoTravarStatus);
        mqtt_envia_mensagem("v1/devices/me/attributes", attributes);
