    ...
    if(xQueueReceive(filaDeInterrupcao, &pino, portMAX_DELAY))
    {
      ...
      if(estado == 1)
      {
        ...
        case porta:
            ...
            mqtt_envia_mensagem2("v1/devices/me/attributes/gpios", "{\"porta\": 1}");
            break;
        case posChave:
            mqtt_envia_mensagem("v1/devices/me/attributes", "{\"posChave\": 1}");
            mqtt_envia_mensagem2("v1/devices/me/attributes/gpios", "{\"posChave\": 1}");
            break;
        case freio:
            mqtt_envia_mensagem("v1/devices/me/attributes", "{\"freio\": 1}");
            mqtt_envia_mensagem2("v1/devices/me/attributes/gpios", "{\"freio\": 1}");
            break;
        case botaoTravar:
            mqtt_envia_mensagem("v1/devices/me/attributes", "{\"botaoTravar\": 1}");
            mqtt_envia_mensagem2("v1/devices/me/attributes/gpios", "{\"botaoTravar\": 1}");
            break;
