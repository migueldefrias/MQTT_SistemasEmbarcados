...
void configuraPinos(){
    ...
    gpio_set_intr_type(porta, GPIO_INTR_POSEDGE);
    gpio_set_intr_type(posChave, GPIO_INTR_POSEDGE);
  ...
  while(true)
  {
    if(xQueueReceive(filaDeInterrupcao, &pino, portMAX_DELAY))
    {
      ...
      if(estado == 1)
      {
        ...
        {
        case porta:
            mqtt_envia_mensagem("v1/devices/me/attributes", "{\"porta\": 1}");
            mqtt_envia_mensagem2("v1/devices/me/attributes/sensores", "{\"porta\": 1}");
            break;
        case posChave:
            mqtt_envia_mensagem("v1/devices/me/attributes", "{\"posChave\": 1}");
            mqtt_envia_mensagem2("v1/devices/me/attributes/sensores", "{\"posChave\": 1}");
            break;
        case freio:
            mqtt_envia_mensagem("v1/devices/me/attributes", "{\"freio\": 1}");
            mqtt_envia_mensagem2("v1/devices/me/attributes/sensores", "{\"freio\": 1}");
            break;
        case botaoTravar:
            mqtt_envia_mensagem("v1/devices/me/attributes", "{\"botaoTravar\": 1}");
            mqtt_envia_mensagem2("v1/devices/me/attributes/sensores", "{\"botaoTravar\": 1}");
            break;
